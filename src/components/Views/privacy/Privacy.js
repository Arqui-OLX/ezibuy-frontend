...
class Privacy extends Component {   
    ...
    render() {
      return(
            <div className="bg-white w-75 mx-auto mt-5 p-5">
 
                <h1 className="text-center font-merriweather font-size-40px mb-5">Politicas de privacidad</h1>  

                <p className="font-Quicksand font-size-15px"> 
                HappyPets te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web happypets.com. 
                ...
                <ul>  
                  <li>Titular: Happy Pets</li>  
                  <li>Domicilio: DIRECCIÓN-POSTAL</li>  
                  <li>Correo electrónico:  HappyPets@admin.com</li> 
                  <li>Sitio Web: happypets.com</li>  

                </ul>  

                <h5 className="font-merriweather font-weigh-bold font-size-22px  mb-5 mt-5">Principios aplicados en el tratamiento de datos</h5>  
                <p className="font-Quicksand font-size-15px mb-4"> 
                ...
                <p className="font-Quicksand font-size-15px mb-4">  
                  Para navegar por happypets.com. no es necesario que facilites ningún dato personal. 
                </p>   
                <ul>  
                ...
                <h5 className="font-merriweather font-weigh-bold font-size-22px  mb-5 mt-5">Tus derechos</h5>  

                <p className="font-Quicksand font-size-15px mb-4">El Titular te informa que sobre tus datos personales tienes derecho a:</p> 
                ...
                <p className="font-Quicksand font-size-15px mb-4" > 
                  ...
                  Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a  happypets@admin.com junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente. 
                ...
                <p className="font-Quicksand font-size-15px mb-4" >  
                  Cuando te conectas al sitio Web para mandar un correo al Titular, te suscribes a su boletín o realizas una contratación, estás facilitando información de carácter personal de la que el responsable es el Titular.  
                ...
                <p className="font-Quicksand font-size-15px mb-4">  
                  ...
                  Los datos que facilites al Titular estarán ubicados en los servidores de The Rocket Science Group LLC d/b/a, con domicilio en EEUU. 
                ...
                <p className="font-Quicksand font-size-15px mb-4">  
                  ...
                  El sitio Web está alojado en Amazon Web Service.  La seguridad de tus datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. 
